...
THIS_IS_NEW_VERSION = "0616_DUAL_STRATEGY_SCORE_LOOSE_5PCT"
...
MIN_SCORE_SHORT = 60      # 5% 전략: 조금 느슨하게
MIN_SCORE_MID = 70        # 30% 전략: 기존처럼 엄격하게
MAX_SHORT_RESULTS = 12    # 5% 전략 최대 표시
MAX_MID_RESULTS = 8       # 30% 전략 최대 표시
